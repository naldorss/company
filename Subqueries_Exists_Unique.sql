-- Subqueries
-- //////////////////////////////////Retorna o numero dos projetos em que Smith esta envolvido //////////////////
...
-- ///// Verificando através da identificação do funcionario os projetos em que ele esta envolvido e o numero de horas em cada projeto ///////////////////////////////////////////
    select distinct *
    from works_on
    where (Pno, Hours) in(
							select Pno, hours
